...
В данном репозитории собраны SQL-запросы, выполненные в рамках обучения тестированию.  
Используется MySQL для работы с данными, проверки их корректности и анализа связей между таблицами интернет-магазина: https://qa.demoshopping.ru/
